...
**Status:** Accepted (PR-A/B/C/D merged; PR-E Web UI in progress — read-only browser + dev-tier override-seed shipped, context install/update deferred — see PR Breakdown)
**Date:** 2026-04-30
