...
> arguments** as the plugin — `uvx --from 'memtomem[onnx]==0.6.5' memtomem-server`
...
>   environment, or `uvx --isolated --from "memtomem[all]==0.6.5"
...
"memtomem[all]==0.6.5" memtomem-server`. If an older user-scope registration
