...
> arguments** as the plugin — `uvx --from 'memtomem[onnx]==0.6.4' memtomem-server`
...
>   environment, or `uvx --isolated --from "memtomem[all]==0.6.4"
...
"memtomem[all]==0.6.4" memtomem-server`. If an older user-scope registration
