...
core `0.6.1`. Add it through OpenCode's singular `plugin` configuration key
...
|---|---|
| MCP | Exact-pinned `memtomem==0.6.1`, core tool mode (plugin); `[all]` no-install runtime (manual MCP) |
