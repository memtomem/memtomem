...
core `0.6.3`. Add it through OpenCode's singular `plugin` configuration key
...
|---|---|
| MCP | Exact-pinned `memtomem[onnx]==0.6.3`, core tool mode (plugin); `[all]` no-install runtime (manual MCP) |
