...
The complete v0.6.3 top-level command catalog is grouped below. Run `mm
...
mm upgrade --version 0.6.3 --dry-run  # preview an exact uv-tool reinstall (also: --grace, --extras, -y/--yes, --json)
