...
The complete v0.3.13 top-level command catalog is grouped below. Run `mm
...
mm upgrade --version 0.3.13 --dry-run  # preview an exact uv-tool reinstall (also: --grace, --extras, -y/--yes, --json)
