...
The full surface contains **100 current tools** plus the deprecated
...
formation actions (`mem_formation_scan`, `mem_candidate_propose/list/evidence/review/recover`). See the
