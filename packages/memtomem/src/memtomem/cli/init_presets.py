...
PRESETS: dict[PresetName, PresetSpec] = {
    ...
    "english": PresetSpec(
        ...
        description="ONNX multilingual-e5-small + English rerank + auto-discover providers",
        provider="onnx",
    ...
    "korean": PresetSpec(
        ...
        description="ONNX multilingual-e5-small + kiwipiepy tokenizer + multilingual rerank",
        provider="onnx",
        model="multilingual-e5-small",
        dimension=384,
        rerank_enabled=True,
