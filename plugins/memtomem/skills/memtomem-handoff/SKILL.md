...
# Hand off project work

Derive the handoff operation (save or resume) from the current user request.
If the request does not clearly specify the handoff operation (save or resume), ask before calling a tool.
